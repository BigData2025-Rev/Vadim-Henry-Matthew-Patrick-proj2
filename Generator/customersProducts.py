...
def makeDict(spark):
    ...
    return {"order_id":orderIds, "customer_id":customerIds, "customer_name":customerNames, "product_id":productIds, "product_name":productNames,"product_category":category, "price":price, "country":customerCountries, "city":custCity, "ecommerce_website_name":website}
